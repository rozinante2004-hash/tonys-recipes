...
**Current version:** `v29.2` (see `version.json`, the HTML comment on line 1, `APP_VERSION`, and
...
| `version.json` | `{"version": "v29.2"}` — polled to detect new deployments. Must never be cached. |
